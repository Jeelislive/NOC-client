  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center mb-4">
        <button
          onClick={goBack}
          className="flex items-center text-white bg-[#212121] mr-4 py-1 px-1 text-lg rounded-full"
        >
          <IoArrowBack className="mr-1 ml-1" />
        </button>
        <h1 className="text-2xl md:text-3xl font-bold mb-0">User List</h1>
      </div>
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                  <select
                    ...
                    onChange={(e) =>
                      updateStatus(user.email, e.target.value, user?.documents)
                    }
